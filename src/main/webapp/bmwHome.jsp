        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                ...
                <div class="home__container container grid">
                    ...
                    <img src="image/bmw_logo.png" alt="Home image" class="home__img">
                ...
                <div class="about__container container grid">
                    ...
                    <div class="about__data">
                        ...
                        <p class="about__description">
                            BMW, short for Bayerische Motoren Werke AG, is a German luxury automobile manufacturer known for its high-performance vehicles, innovative engineering, and stylish designs. Founded in 1916, BMW started as an aircraft engine producer before transitioning to motorcycles and cars. The brand is renowned for its commitment to driving dynamics, advanced technology, and premium quality.
                        </p>
                ...
                <div class="popular__container container swiper">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">BMW</h2>
                            <h3 class="popular__subtitle">M5</h3>

                            <img src="carImg/bmwhome/m5.png" alt="popular image" class="popular__img">
                            ...
                            <div class="popular__data">
                                ...
                                <div class="popular__data-group">
                                    <i class="ri-charging-pile-2-line"></i> V8
                                </div>
                            </div>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">BMW</h2>
                            <h3 class="popular__subtitle">M4</h3>

                            <img src="carImg/bmwhome/m4.png" alt="popular image" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">BMW</h2>
                            <h3 class="popular__subtitle">M8</h3>

                            <img src="carImg/bmwhome/m8.png" alt="popular image" class="popular__img">
                            ...
                            <div class="popular__data">
                                ...
                                <div class="popular__data-group">
                                    <i class="ri-charging-pile-2-line"></i> V10
                                </div>
                            </div>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">BMW</h2>
                            <h3 class="popular__subtitle">3.0 CSL hommage R</h3>

                            <img src="carImg/bmwhome/BMW_3.0_CSL.png" alt="popular image" class="popular__img">
                            ...
                            <div class="popular__data">
                                ...
                                <div class="popular__data-group">
                                    <i class="ri-charging-pile-2-line"></i> V6
                                </div>
                            </div>
