        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                ...
                <div class="home__container container grid">
                    ...
                    <img src="carImg/fenyer/fenyer.png" alt="Home image" class="home__img">
                    ...
                    <div class="home__car">
                        <div class="home__car-data">
                            ...
                            <h2 class="home__car-number">800hp</h2>
                            <h3 class="home__car-name">POWER</h3>
                        </div>
                        ...
                        <div class="home__car-data">
                            ...
                            <h2 class="home__car-number">10 km/l</h2>
                        ...
                        <div class="home__car-data">
                            ...
                            <h2 class="home__car-number">7 speed</h2>
                            <h3 class="home__car-name">Transmission</h3>
                        </div>
            ...
            <section class="popular section" id="popular">
                <h2 class="section__title">
                    Choose Your Dream Car <br> Of The W Motors Brand 
                </h2>
                ...
                <div class="popular__container container swiper">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">Porsche</h2>
                            <h3 class="popular__subtitle">Turbo S</h3>

                            <img src="carImg/porche/popular1.png" alt="popular image" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="carImg/porche/popular2.png" alt="popular image" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="carImg/porche/popular3.png" alt="popular image" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="carImg/porche/popular4.png" alt="popular image" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="carImg/porche/popular5.png" alt="popular image" class="popular__img">
            ...
            <section class="features section">
                ...
                <div class="features__container container grid">
                    <div class="features__group">
                        <img src="carImg/fenyer/fyenr_top.png" alt="Features image" class="features__img">
                    
                        <div class="features__card features__card-1">
                            <h3 class="features__card-title">800 hp</h3>
                            <p class="features__card-description">Turbo <br> Chargin</p>
                        </div>
                        <div class="features__card features__card-2">
                            <h3 class="features__card-title">100 km/h</h3>
                            <p class="features__card-description">3.1 <br> seconds</p>
                        </div>
