        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                ...
                <div class="home__container container grid">
                    ...
                    <img src="image/lamborghini_logo.png" alt="Home image" class="home__img">
            ...
            <section class="about section" id="about">
                <div class="about__container container grid">
                    <div class="about__group">
                        <img src="carImg/revuelto/feature.jpg" alt="about image" class="about__img">
                    ...
                    <div class="about__data">
                        <h2 class="section__title about__title">
                           LAMBORGHINI:  <br> Expect the Unexpected
                        </h2>
...
Lamborghini often uses various phrases and slogans in marketing campaigns, but "Expect the Unexpected" is a consistent representation of their brand ethos. If you need more details or examples.
            ...
            <section class="popular section" id="popular">
                <h2 class="section__title">
                    Choose Your Dream  <br> LAMBORGHINI
                </h2>
                ...
                <div class="popular__container container swiper">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">LAMBORGHINI</h2>
                            <h3 class="popular__subtitle">Aventador SVJ<br>Roadstar</h3>

                            <img src="carImg/lambo/Lamborghini-Aventador-svj-roadstar.png" alt="popular image" class="popular__img">

                            <div class="popular__data">
                                <div class="popular__data-group">
                                    <i class="ri-dashboard-3-line"></i> 2.9 sec
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-funds-box-line"></i> 350 km/h
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-charging-pile-2-line"></i> 6.5-liter V12
                                </div>
                            </div>

                            <h3 class="popular__price">$573,966</h3>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">LAMBORGHINI</h2>
                            <h3 class="popular__subtitle">Sian SKF</h3>

                            <img src="carImg/lambo/sian.png" alt="popular image" class="popular__img">

                            <div class="popular__data">
                                <div class="popular__data-group">
                                    <i class="ri-dashboard-3-line"></i> 2.8 sec
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-funds-box-line"></i> 350 km/h
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-charging-pile-2-line"></i>6.5-lite<br>V12 hybrid
                                </div>
                            </div>

                            <h3 class="popular__price">$3.6 million</h3>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">LAMBORGHINI</h2>
                            <h3 class="popular__subtitle">Huracan STO</h3>

                            <img src="carImg/lambo/Huracan-STO.png" alt="popular image" class="popular__img">

                            <div class="popular__data">
                                <div class="popular__data-group">
                                    <i class="ri-dashboard-3-line"></i>3.0 sec
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-funds-box-line"></i>310 km/h
                                </div>
                                <div class="popular__data-group">
                            ...
                            <h3 class="popular__price">$327,838</h3>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="carImg/lambo/aventador-svj.png" alt="popular image" class="popular__img">

                            <div class="popular__data">
                                <div class="popular__data-group">
                                    <i class="ri-dashboard-3-line"></i>2.8sec
                                </div>
                                <div class="popular__data-group">
                                    <i class="ri-funds-box-line"></i>350 km/h
                                </div>
                            ...
                            <h3 class="popular__price">$517,770</h3>
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <h2 class="popular__title">LAMBORGHINI</h2>
                            <h3 class="popular__subtitle">Urus</h3>

                            <img src="carImg/lambo/urus.png" alt="popular image" class="popular__img">

                            <div class="popular__data">
                                <div class="popular__data-group">
                                    <i class="ri-dashboard-3-line"></i>3.6sec
                                </div>
                                <div class="popular__data-group">
                            ...
                            <h3 class="popular__price">$225,000</h3>
